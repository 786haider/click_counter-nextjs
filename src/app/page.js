...
export default function Home() {
  ...
  return (
    <div className="bg-black min-h-screen justify-center flex items-center flex-col gap-6">
      <div id="counter" className="text-white text-2xl">Counter Value : 0</div>
      <button onClick={handleClick} className="bg-yellow-500 rounded-2xl px-6 py-2 hover:bg-blue-500 active:bg-white">Click Me</button>
